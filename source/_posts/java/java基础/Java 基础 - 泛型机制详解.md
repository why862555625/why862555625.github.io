...
![image-20230816144046682](https://raw.githubusercontent.com/why862555625/images/main/imagesimage-20230816144046682.png)

- 调用泛型方法语法格式

![image-20230816144057673](https://raw.githubusercontent.com/why862555625/images/main/imagesimage-20230816144057673.png)
...
![img](images/java/java-basic-generic-1.png)
...
![img](images/java/java-basic-generic-2.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![img](images/java/java-basic-generic-3.png)
